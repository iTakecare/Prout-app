...
const DEMOS: Demo[] = [
  {
    lead: {
      ...
      notes:
        "Exploitation laitière 220 têtes. Cherche à valoriser ses effluents et à sécuriser sa facture énergétique.",
      age: "-26 days",
    },
    assessment: {
  ...
  },
  {
    lead: {
      ...
      estimated_value: 0,
      notes:
        "Plateforme logistique avec invendus alimentaires importants. Premier contact à organiser.",
      age: "-2 days",
    },
  },
  {
    lead: {
      ...
      notes:
        "Contrat signé — unité de biométhane avec injection réseau. Chantier planifié.",
      age: "-120 days",
    },
    assessment: {
  ...
  },
  {
    lead: {
      ...
      notes:
        "Unité en exploitation depuis 14 mois. Contrat de maintenance Waste-end actif.",
      age: "-430 days",
    },
    assessment: {
  ...
  },
  {
    lead: {
      ...
      estimated_value: 0,
      notes:
        "Gisement trop faible et irrégulier pour une unité dédiée. Orienté vers une collecte mutualisée.",
      age: "-60 days",
    },
    activities: [
